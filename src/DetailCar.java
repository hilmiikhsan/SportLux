...
public class DetailCar extends JFrame {
	...
	public DetailCar() {
		...
		lblNewLabel_3_1_1.setIcon(new ImageIcon(DetailCar.class.getResource("/images/bmw-z4.png")));
		lblNewLabel_3_1_1.setBounds(86, 66, 303, 513);
		...
		lblNewLabel_3_1.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				formCar.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
				dispose();
			}
		});
